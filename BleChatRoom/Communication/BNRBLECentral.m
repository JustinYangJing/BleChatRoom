...
-(void)scanPeripheralWithTimeOut:(NSInteger)timeOut{
    [self.manager scanForPeripheralsWithServices:@[[CBUUID UUIDWithString:kSeriversUUID],[CBUUID UUIDWithString:kSeriversUUID1]]
...
-(void)writeData:(NSData *)data{
    [self.connectedPeripheral writeValue:data forCharacteristic:self.writeChara type:CBCharacteristicWriteWithResponse];
}
...
-(void)centralManager:(CBCentralManager *)central didConnectPeripheral:(CBPeripheral *)peripheral{
    ...
    [peripheral discoverServices:@[[CBUUID UUIDWithString:kSeriversUUID],[CBUUID UUIDWithString:kSeriversUUID1]]];
}
...
-(void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error{
    ...
    for (CBService *service in peripheral.services) {
        ...
        }else if ([service.UUID.UUIDString isEqualToString:kSeriversUUID1]) {
            [peripheral discoverCharacteristics:@[[CBUUID UUIDWithString:kWriteCharUUID1],[CBUUID UUIDWithString:kReadCharUUID1]] forService:service];
        }
    }
}
